...
set search=%search: =%
::Software free
if /i "%search%"=="Zenon_1.8" set "u=https://i.imgur.com/pTGieeT.png" &set "url=https://www.mediafire.com/file/a0i6ize4mmazs35/Zenon_1.8.zip/file" &goto software 
...
if /i "%search%"=="GSMdrivers" set "u=https://i.imgur.com/B6gGz8y.png" &set "url=https://www.mediafire.com/file/l4700etvt3l5928/GSM_Drivers_Installer_setup.rar/file" &goto software
...
if /i "%search%"=="Samfw" set "u=https://i.imgur.com/o0Vl3U4.png" &set "url=https://www.mediafire.com/file/upaiwadhmstm6js/SamFwToolSetup_v4.6.zip/file" &goto software
if /i "%search%"=="TFT" set "u=https://i.imgur.com/yhWsOV0.png" &set "url=https://drive.google.com/file/d/1C05zYjtFFSUHX6gOaROeO7MOj8mWNBr0/view" &goto software 
if /i "%search%"=="TC12N1" set "u=https://imgur.com/pX4sW9G" &set "url=https://drive.google.com/u/0/uc?id=1DpY_IlEbK4Zqq-7TitmBNZqv7vK5cC9-&export=download" &goto software
...
if /i "%search%"=="iFRPFILE_AIO_v2.8.6" set "u=https://i.imgur.com/NSnYoda.png" &set "url=https://www.mediafire.com/file/4k75elmcy6gloit/iFRPFILE_AIO_v2.8.6.zip/file" &goto software 
::Manual Referrences
